...
// Correction timezone pour affichage correct
...
// --- AJOUT : Récupération notifications et messages pour le dashboard employé ---
try {
    ...
    error_log('Erreur SQL notifications employé : ' . $e->getMessage());
    $notifications = [];
}
try {
    ...
    error_log('Erreur SQL count notifications employé : ' . $e->getMessage());
...
try {
    ...
    error_log('Erreur SQL messages employé : ' . $e->getMessage());
    $messages = [];
}
try {
    ...
    error_log('Erreur SQL count messages employé : ' . $e->getMessage());
...
// Marquer une notification comme lue via AJAX
  document.querySelectorAll('.notifications-section li.unread').forEach(item => {
